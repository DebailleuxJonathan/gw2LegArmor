...
public class textEpauleLourd extends JTextArea {

   public textEpauleLourd(){
       setText("(Légendaire) Espauliers du Héros triomphant de la forge des Brumes : \n" + "Vous devez avoir avant le rang McM 1700 ainsi que l’apparence des Espauliers du Héros triomphant de la forge des Brumes en rareté élevé. \n"
               +
               "\n" +
               "Le craft :\n" +
               "\n" +
